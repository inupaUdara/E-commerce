        ...
        <div className="my-18 text-sm text-slate-600">
                    ...
                    {ratings.map((item,index) => (
                        <div key={index} className="flex gap-5 mb-10">
                            ...
                            <div>
                                ...
                                <p className="text-sm max-w-lg my-4">{item?.review || 'No review text provided.'}</p>
            ...
            <div className="flex gap-3 mt-14">
                ...
                <div>
                    ...
                    <Link href={store?.username ? `/shop/${store.username}` : '/shop'} className="flex items-center gap-1.5 text-green-500"> view store <ArrowRight size={14} /></Link>
                </div>
            </div>
        </div>
    )
